...
class HTMLModulesPlugin {
	constructor() {
		this.pluginName = "HTMLModulesPlugin";
	...
	apply(compiler) {
		...
		compilation.tap(pluginName, (compilation, {
			...
			createParser.for("html/experimental").tap(pluginName, () => {

				return new HTMLParser();
			});

			createGenerator.for("html/experimental").tap(pluginName, () => {
			...
			chunkTemplate.hooks.renderManifest.tap(pluginName, (result, options) => {
